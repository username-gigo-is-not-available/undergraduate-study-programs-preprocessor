...
async def main() -> None:
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as thread_executor:
        input_data_file_paths: dict[str, str] = get_input_data_file_paths()
        ...
        processed_data: list[dict[str, str | pd.DataFrame]] = prepare_data_for_saving(raw_data.get('study_programs'), raw_data.get('curricula'),
