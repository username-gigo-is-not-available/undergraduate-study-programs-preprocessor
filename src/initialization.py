...
def create_warehouse_if_not_exists() -> None:
...
def initialize():
    ...
    namespace: str = StorageConfiguration.ICEBERG_DESTINATION_NAMESPACE
    ...
    for dataset in datasets:
        table_identifier: str = iceberg_client.generate_table_identifier(namespace, dataset.dataset_name)
